                ...
                <div className="leftView">
                    ...
                    <div className="socialIconContainer">
                        <div className="iconBox">
                            ...
                            <a className="social-icon" href="javascript:alert('Link is not available');" target="_blank" rel="noopener noreferrer"><Facebook /></a>
                            ...
                            {/* <div onClick={externalLink}><Instagram /></div> */}
                        </div>
                    </div>
                </div>
